...
import { getStockDetailsById } from "../redux/slices/billingDetails/ezBillingDetailsSlice";
...
const AddStock = () => {
    ...
    const { StockDetailsById, isStockDetailsByIdPending } = useSelector((state) => state.ezInvoiceDetails);
    ...
    const handleRegister = (formValue) => {
        ...
        dispatch(getStockDetailsById({ id }))
    ...
    return (<div>
        {!isEdit && <div className="col-md-12 signup-form">
            <div className="card card-container">
                <h3>Select Product to Add Stock</h3>
                <Formik
        ...
        {StockDetailsById && !isStockDetailsByIdPending && isEdit && <AddStockDetails />}
    </div>
    );
};
